...
function Home() {
  return (
    <>
      <div className="background-img center flex flex-col md:flex-row md:space-x-3 py-10 border-4 border-t-red-500 m-auto dark:border-l-slate-950 dark:border-r-slate-950 dark:border-b-slate-950">
